package TestNG2;
        ...
        import TestNG2.TestNG_Screenshots;

public class TestNG_ScreenshotsOnFailTest {
...
// If you also encouter the issues, please comment the above code for goButton and un-comment the below code
    ...
    @AfterMethod
    //will evaluate the result of the last test method and if false, will take a screenshot using the method from the other java class file
    public void tearDown(ITestResult testResult) throws IOException {
        if(testResult.getStatus() == ITestResult.FAILURE) {
            TestNG_Screenshots.takeScreenshot(driver, testResult.getName());
        }
        driver.quit();
    }
}